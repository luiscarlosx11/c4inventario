<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="agregar.aspx.cs" Inherits="elecion.tickets.agregar" %>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                                ...
                                                <span class="float-xs-left">								                                                                                                                                                                              
                                                      ...
                                                      <asp:Button runat="server" ID="seguimiento" OnClick="iniciarSeguimiento"  class="ocultar" />                                
                                                         ...
                                                         -->                                                                                                                                                                          
                                                        <button type="button" class="btn btn-danger mr-1" data-toggle="tooltip" data-original-title="Finalizar" onclick="finalizarModal()" >
	                                                            <i class="ft-x"></i> Finalizar  
	                                                    </button> 
                                                    ...
                                                    <button type="button" class="btn btn-primary mr-1" data-toggle="tooltip" data-original-title="Finalizar" onclick="seguimiento()" id="seguir" runat="server">
	                                                            <i class="ft-check"></i> Seguimiento  
	                                                    </button> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
                                            ...
                                            <asp:HiddenField ID="atiendeant" runat="server" Value="0"/></asp>
											<asp:DropDownList runat="server" ID="atiende" CssClass="select2 form-control" DataSourceID="Dsusuarios" DataTextField="nombre" OnSelectedIndexChanged="actualizarAtiende" AutoPostBack="true" DataValueField="idusuario" style="width:100%" AppendDataBoundItems="true" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<asp:DropDownList runat="server" ID="cliente" CssClass="select2 form-control" DataSourceID="Dsclientes" DataTextField="nombre" DataValueField="idcliente" OnDataBound="clientes_DataBound" OnSelectedIndexChanged="actualizar" AutoPostBack="true" style="width:100%">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<asp:DropDownList runat="server" ID="contrato" CssClass="select2 form-control" DataSourceID="Dscontratos" DataTextField="nombre" DataValueField="idcontrato" OnSelectedIndexChanged="actualizar" style="width:100%" AutoPostBack="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<asp:TextBox ID="concepto" CssClass="form-control"  placeholder="Concepto" MaxLength="50" name="nombre" runat="server" OnTextChanged="actualizar" AutoPostBack="true"></asp:TextBox>
										</div>
									</div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                                 ...
                                                 <asp:DropDownList runat="server" ID="prioridad" CssClass="select2 form-control" DataSourceID="Dsprioridades" DataTextField="prioridad" DataValueField="idprioridad"  AutoPostBack="true" style="width:100%" OnSelectedIndexChanged="actualizar">                                                
                                                 </asp:DropDownList>                                                
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<asp:DropDownList runat="server" ID="tiposervicio" CssClass="select2 form-control" DataSourceID="DsTipo" DataTextField="tiposervicio" DataValueField="idtiposervicio"  AutoPostBack="true" style="width:100%" OnSelectedIndexChanged="actualizar">                                                
                                                 </asp:DropDownList>                                                
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                                 ...
                                                 <asp:DropDownList runat="server" ID="lugarservicio" CssClass="select2 form-control" DataSourceID="DsLugares" DataTextField="lugarservicio" DataValueField="idlugarservicio"  AutoPostBack="true" style="width:100%" OnSelectedIndexChanged="actualizar">                                                
                                                 </asp:DropDownList>                                                
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
	                            	        <label for="observaciones" class="text-bold-600">Observaciones</label>		                                                                                  
                                              <asp:TextBox ID="observaciones" CssClass="form-control" Rows="3" TextMode="MultiLine" placeholder="Observaciones" name="observaciones" runat="server" OnTextChanged="actualizar"  AutoPostBack="true" ></asp:TextBox>                                              		                                     
		                             </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											...
											<asp:TextBox ID="contacto" CssClass="form-control"  placeholder="Contacto" MaxLength="50" name="nombre" runat="server" OnTextChanged="actualizar"  AutoPostBack="true"></asp:TextBox>
										</div>                                       
									</div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
											...
											<asp:TextBox ID="contactotel" CssClass="form-control"  placeholder="Teléfono" MaxLength="50" name="nombre" runat="server" OnTextChanged="actualizar"  AutoPostBack="true"></asp:TextBox>
										</div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
											...
											<asp:TextBox ID="contactomail" CssClass="form-control"  placeholder="Email" MaxLength="50" name="nombre" runat="server" OnTextChanged="actualizar"  AutoPostBack="true"></asp:TextBox>
										</div> 
                                    </div>
                         ...
                         <ContentTemplate>
                                 <section id="timeline" class="timeline-center timeline-wrapper">
                                        ...
                                        <ul class="timeline">
                                          <li class="timeline-line"></li>
                                          <li class="timeline-group">
                                            <a href="javascript:void(0)" class="btn btn-primary" onclick="abrirModal()"><i class="fa fa-calendar-o"></i>  Nueva nota</a>
                                          </li>
                                        </ul>
                                  </section>
	                                                                                    ...
	                                                                                    <div class="card-block">
	                    	                                                                    ...
	                    	                                                                    <div class="form-body">	
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                             ...
                                                                                                             <asp:DropDownList runat="server" ID="terminacion" CssClass="select2 form-control" DataSourceID="DSFinalizacion" DataTextField="terminacion" DataValueField="idterminacion"   style="width:100%">                                                
                                                                                                             </asp:DropDownList>                                                
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        function seguimiento() {
             ...
             swal({
                 title: "Se marcará el inicio de seguimiento del ticket, ¿Desea continuar?",
                 text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
