<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="listadohistorico.aspx.cs" Inherits="elecion.tickets.listadohistorico" %>
			...
			<div class="card box-shadow-1">
				<div class="card-header">
                    ...
                    <div>
                        ...
                        <span><b>Inicio</b> <%# Eval("fecha") + " - " + Eval("hora") + " hrs." %></span><br />
                        <span><b>Fin</b> <%# Eval("fecha") + " - " + Eval("hora") + " hrs." %></span>
