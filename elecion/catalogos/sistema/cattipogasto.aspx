<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="cattipogasto.aspx.cs" Inherits="elecion.catalogos.sistema.cattipogasto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending rendila-color" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="tipogasto" HeaderText="Tipo de Gasto" SortExpression="tipoventa" />                           
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idtipogasto, tipogasto from tipogasto order by tipogasto"></asp:SqlDataSource>
                               </div>
                            </div>
    ...
    <div class="modal fade text-xs-left" id="bootstrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h3 class="modal-title" id="myModalLabel35">TIPO DE GASTO</h3>
			        </div>
                                                  ...
                                                  <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="descripcion" CssClass="form-control text-uppercase" required="required" data-validation-required-message="Campo requerido" MaxLength="60" placeholder="Tipo de gasto" name="tipogasto" runat="server"></asp:TextBox>
