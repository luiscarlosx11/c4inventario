<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" EnableEventValidation="false" AutoEventWireup="true" 
    CodeBehind="frminstructor.aspx.cs" Inherits="elecion.catalogos.directorio.frminstructor" %>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-basic">Datos del Instructor</h4>
