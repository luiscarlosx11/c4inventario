<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catentidades.aspx.cs" Inherits="elecion.catalogos.geograficos.catentidades" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
             ...
             <div class="content-header row">
                   ...
                   <div class="col-md-3">
                       ...
                       <div class="media-body">
                           <h4 class="font-weight-bold">Entidades</h4>
            ...
            <div class="row" id="header-styling">
                <div class="col-xs-12">
                    <div class="card">
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="50" AllowPaging="true" AllowSorting="true" CssClass="table table-striped lGeneral" 
                                ...
                                GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="entidad" HeaderText="Entidad" SortExpression="entidad" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/> 
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("identidad")%>,'<%# Eval("entidad").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select identidad, entidad from entidad">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">ENTIDAD</h5>                                                                               
    ...
    <script>
        ...
        function valida() {
           ...
           var nombre = $("*[id$='nombre']").val();
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese el nombre de la entidad', 'warning', $("*[id$='nombre']"));                
                return false;
