<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catlugares.aspx.cs" Inherits="elecion.catalogos.servicio.catlugares" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">LISTADO DE LUGARES</h4>
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending" BackColor="#16D39A" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="lugarservicio" HeaderText="Lugar" SortExpression="lugarservicio" />                           
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                                                <ItemTemplate>

                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idlugarservicio")%>,'<%# Eval("lugarservicio").ToString() %>');" class="btn btn-icon btn-success mr-1"
                                                        data-toggle="tooltip" data-original-title="Editar" >
                                                         <i class="ft-edit"></i>
                                                    </button>

                                                     <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idlugarservicio")%>,'<%# Eval("lugarservicio").ToString() %>');" class="btn btn-icon btn-danger mr-1"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idlugarservicio, lugarservicio from lugarservicio order by lugarservicio"></asp:SqlDataSource>
                               </div>
                            </div>
    ...
    <div class="modal fade text-xs-left" id="bootstrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h3 class="modal-title" id="myModalLabel35">LUGAR DE SERVICIO</h3>
			        </div>
	                    		                            ...
	                    		                            <form id="formaRegistro" method="get">
                                                                ...
                                                                <div class="form-group row">
		                                                            ...
		                                                            <div class="col-md-9">
                                                                        ...
                                                                        <asp:TextBox ID="tipogasto" CssClass="form-control" required="required" data-validation-required-message="Campo requerido" maxlength="60" placeholder="Lugar" name="tipogasto" runat="server" ></asp:TextBox>
    ...
    <script>
        ...
        function valida() {
            ...
            if (tipogasto == '' ) {
                ...
                if (tipogasto == '')
                    swal("Atención", "Ingrese el lugar del servicio", "warning");
