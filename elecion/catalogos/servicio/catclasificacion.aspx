<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catclasificacion.aspx.cs" Inherits="elecion.catalogos.servicio.catclasificacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="titulobreads" runat="server">
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h3 class="content-header-title">Catálogos de Servicio</h3>
          </div>
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Servicio</a>
                </li>
              </ol>
            </div>
          </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">LISTADO DE CLASIFICACIÓN</h4>
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending" BackColor="#16D39A" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="tiposervicio" HeaderText="Clasificación" SortExpression="tiposervicio" />                           
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                                                <ItemTemplate>

                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idtiposervicio")%>,'<%# Eval("tiposervicio").ToString() %>');" class="btn btn-icon btn-success mr-1"
                                                        data-toggle="tooltip" data-original-title="Editar" >
                                                         <i class="ft-edit"></i>
                                                    </button>

                                                     <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idtiposervicio")%>,'<%# Eval("tiposervicio").ToString() %>');" class="btn btn-icon btn-danger mr-1"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idtiposervicio, tiposervicio from tiposervicio order by tiposervicio"></asp:SqlDataSource>
                               </div>
                            </div>
    ...
    <div class="modal fade text-xs-left" id="bootstrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h3 class="modal-title" id="myModalLabel35">CLASIFICACIÓN DE SERVICIO</h3>
			        </div>
	                    		                            ...
	                    		                            <form id="formaRegistro" method="get">
                                                                ...
                                                                <div class="form-group row">
		                                                            ...
		                                                            <div class="col-md-9">
                                                                        ...
                                                                        <asp:TextBox ID="tipogasto" CssClass="form-control" required="required" data-validation-required-message="Campo requerido" maxlength="60" placeholder="Clasificación" name="tipogasto" runat="server" ></asp:TextBox>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $("#catclasificacion").addClass("active");
        ...
        function valida() {
            ...
            if (tipogasto == '' ) {
                ...
                if (tipogasto == '')
                    swal("Atención", "Ingrese la clasificación del servicio", "warning");
