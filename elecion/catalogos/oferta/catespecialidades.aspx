<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catespecialidades.aspx.cs" Inherits="elecion.catalogos.oferta.catespecialidades" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3" id="datiende" runat="server">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList runat="server" ID="bcategoria" CssClass="select2 form-control" DataSourceID="Dsusuarios" DataTextField="area" OnSelectedIndexChanged="listadoGrid" AutoPostBack="true" DataValueField="idarea" Style="width: 100%" AppendDataBoundItems="false" OnDataBound="listadoGrid" >
                                                            <asp:ListItem Value="0">Seleccione un área</asp:ListItem>
                                                        </asp:DropDownList>
                                                ...
                                                <div class="col-md-4" id="Div1" runat="server">
                                                    <div class="form-group">                                                        
                                                        <label class="text-bold-600">Especialidad</label>                                                                                                                                              
                                                            <asp:TextBox ID="bmunicipio" CssClass="form-control text-uppercase" required="required" data-validation-required-message="Campo requerido" MaxLength="60" placeholder="Especialidad" name="nombre" runat="server" AutoPostBack="true" OnTextChanged="listadoGrid"></asp:TextBox>
                                                    </div>
                                                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $("#catespecialidades").addClass("active");
