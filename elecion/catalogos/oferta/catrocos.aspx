<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false"
     CodeBehind="catrocos.aspx.cs"  Inherits="elecion.catalogos.oferta.catrocos" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Generales" >
                                                <ItemTemplate>
                                                    ...
                                                    <h5 class="text-bold-700"><%# Eval("clave")+ " / "+Eval("nombre")%></h5>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="alumnosminimo" type="number" CssClass="form-control text-uppercase" placeholder="Mínimo de alumnos" name="alumnosminimo" runat="server" Text="0"></asp:TextBox>
