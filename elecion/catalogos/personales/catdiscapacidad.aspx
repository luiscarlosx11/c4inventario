<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catdiscapacidad.aspx.cs" Inherits="elecion.catalogos.personales.catdiscapacidad" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
             ...
             <div class="content-header row">
                   ...
                   <div class="col-md-3">
                       <div class="media-left media-middle">
                           <i class="fa fa-wheelchair primary font-large-2 mr-1"></i>
                       </div>
                       <div class="media-body">
                           <h4 class="font-weight-bold">Discapacidad</h4>
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true"  CssClass="table table-striped lGeneral" 
                                ...
                                GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="discapacidad" HeaderText="Nombre" SortExpression="discapacidad" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/> 
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("iddiscapacidad")%>,'<%# Eval("clave").ToString() %>','<%# Eval("discapacidad").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select iddiscapacidad, clave, discapacidad from discapacidad ">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">DISCAPACIDAD</h5>                                                                               
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $("#catdiscapacidad").addClass("active");
        ...
        function valida() {
            ...
            if (clave == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la clave para la discapacidad', 'warning', $("*[id$='clave']"));                
                return false;
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese el nombre de la discapacidad', 'warning', $("*[id$='nombre']"));                
                return false;
