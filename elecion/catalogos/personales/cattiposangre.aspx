<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="cattiposangre.aspx.cs" Inherits="elecion.catalogos.personales.cattiposangre" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
             ...
             <div class="content-header row">
                   ...
                   <div class="col-md-3">
                       <div class="media-left media-middle">
                           <i class="fa fa-plus-square primary font-large-2 mr-1"></i>
                       </div>
                       <div class="media-body">
                           <h4 class="font-weight-bold">Tipo de Sangre</h4>
                                ...
                                GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                           <asp:BoundField DataField="clave" HeaderText="Clave" SortExpression="clave" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda font-small-3"/> 
                                            ...
                                            <asp:BoundField DataField="tiposangre" HeaderText="Nombre" SortExpression="tiposangre" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/> 
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idtiposangre")%>,'<%# Eval("clave").ToString() %>','<%# Eval("tiposangre").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idtiposangre, clave, tiposangre from tiposangre ">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">TIPO DE SANGRE</h5>                                                                               
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        function valida() {
            ...
            if (clave == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la clave para el tipo de sangre', 'warning', $("*[id$='clave']"));                
                return false;
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese el tipo de sangre', 'warning', $("*[id$='nombre']"));
                return false;
