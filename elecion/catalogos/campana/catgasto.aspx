<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catgasto.aspx.cs" Inherits="elecion.catalogos.campana.catgasto" %>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Tipos de Gasto</a>
                </li>
              </ol>
            </div>
          </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">LISTADO DE TIPOS DE GASTO</h4>
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending" BackColor="#16D39A" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="tipogasto" HeaderText="Tipo de Gasto" SortExpression="tipogasto" />                           
                                            <asp:TemplateField HeaderText="Acciones">
                                                <ItemTemplate>

                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idtipogasto")%>,'<%# Eval("tipogasto").ToString() %>');" class="btn btn-icon btn-success mr-1"
                                                        data-toggle="tooltip" data-original-title="Editar" >
                                                         <i class="ft-edit"></i>
                                                    </button>

                                                     <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idtipogasto")%>,'<%# Eval("tipogasto").ToString() %>');" class="btn btn-icon btn-danger mr-1"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT [idtipogasto], [tipogasto] FROM [tipoGasto] ORDER BY [tipogasto] asc"></asp:SqlDataSource>
                               </div>
                            </div>
    ...
    <div class="modal fade text-xs-left" id="bootstrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h3 class="modal-title" id="myModalLabel35">DETALLE DE TIPO DE GASTO</h3>
			        </div>
	                    	                            ...
	                    	                            <div class="form-body">
	                    		                            <form id="formaRegistro" method="get">
                                                                ...
                                                                <div class="form-group row">
	                            	                                <label class="col-md-3 label-control" for="tipogasto">Tipo de Gasto</label>
		                                                            <div class="col-md-9">
                                                                        ...
                                                                        <asp:TextBox ID="tipogasto" CssClass="form-control" required="required" data-validation-required-message="Campo requerido" maxlength="60" placeholder="Tipo de Gasto" name="tipogasto" runat="server" ></asp:TextBox>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        $(document).prop('title', 'PLACEL - Listado de Tipos de Gasto');
        $(".nav-item>ul>li.active").removeClass("active");
        $("#catgasto").addClass("active");
