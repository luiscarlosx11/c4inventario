<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catdocumentacion.aspx.cs" Inherits="elecion.catalogos.generales.catdocumentacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
                ...
                <div class="col-xs-12">
                   ...
                   <div class="col-md-3">
                       <div class="media-left media-middle">
                           <i class="fa fa-paperclip primary font-large-2 mr-1"></i>
                       </div>
                       <div class="media-body">
                           <h4 class="font-weight-bold">Documentación</h4>
                                ...
                                AutoGenerateColumns="False" DataSourceID="DsListadoGastos" OnSorting="lgastos_Sorting" EnableSortingAndPagingCallbacks="true"
                                  GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="documentacion" HeaderText="Nombre" SortExpression="documentacion" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/>  
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("iddocumentacion")%>,'<%# Eval("clave").ToString() %>','<%# Eval("documentacion").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select iddocumentacion, clave, documentacion from documentacion ">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">DOCUMENTACIÓN</h5>                                                                               
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $("#catdocumentacion").addClass("active");
        ...
        function valida() {
           ...
           var clave = $("*[id$='clave']").val();
            ...
            if (clave == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la clave para la documentacion', 'warning', $("*[id$='clave']"));                
                return false;
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese el nombre de la documentación', 'warning', $("*[id$='nombre']"));
                return false;
