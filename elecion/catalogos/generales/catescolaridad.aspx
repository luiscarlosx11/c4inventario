<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catescolaridad.aspx.cs" Inherits="elecion.catalogos.generales.catescolaridad" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
               ...
               <div class="content-header row">
                   ...
                   <div class="col-md-3">
                       <div class="media-left media-middle">
                           <i class="fa fa-certificate primary font-large-2 mr-1"></i>
                       </div>
                       <div class="media-body">
                           <h4 class="font-weight-bold">Escolaridad</h4>
            ...
            <div class="row" id="header-styling">
                <div class="col-xs-12">
                    <div class="card">
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true" CssClass="table table-striped table-bordered zero-configuration" 
                                ...
                                GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="escolaridad" HeaderText="Nombre" SortExpression="escolaridad" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/> 
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idescolaridad")%>,'<%# Eval("clave").ToString() %>','<%# Eval("escolaridad").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idescolaridad, clave, escolaridad from escolaridad ">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">ESCOLARIDAD</h5>                                                                               
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $("#catescolaridad").addClass("active");
        ...
        function valida() {
           ...
           var clave = $("*[id$='clave']").val();
            ...
            if (clave == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la clave para la escolaridad', 'warning', $("*[id$='clave']"));                
                return false;
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la escolaridad', 'warning', $("*[id$='nombre']"));
                return false;
