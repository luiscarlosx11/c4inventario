<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catmotivos.aspx.cs" Inherits="elecion.catalogos.capacitacion.catmotivos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
             ...
             <div class="content-header row">
                ...
                <div class="col-md-3">
                    <div class="media-left media-middle">
                        <i class="fa fa-check-square-o primary font-large-2 mr-1"></i>
                    </div>
                    <div class="media-body">
                        <h4 class="font-weight-bold">Motivos de Elección</h4>
            ...
            <div class="row" id="header-styling">
                <div class="col-xs-12">
                    <div class="card">
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped lGeneral" 
                                AutoGenerateColumns="False" DataSourceID="DsListadoGastos" OnSorting="lgastos_Sorting" EnableSortingAndPagingCallbacks="true"
                                 GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="clave" HeaderText="Clave" SortExpression="clave" ItemStyle-Width="20px"  HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda font-small-3"/> 

                                            <asp:BoundField DataField="motivo" HeaderText="Nombre" SortExpression="motivo" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/> 
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idmotivo")%>,'<%# Eval("clave").ToString() %>','<%# Eval("motivo").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idmotivo, clave, motivo from motivoeleccion order by motivo ">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">MOTIVO DE ELECCIÓN</h5>                                                                               
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="nombre" CssClass="form-control text-uppercase" required="required" data-validation-required-message="Campo requerido" MaxLength="100" placeholder="Nombre" name="nombre" runat="server"></asp:TextBox>
       ...
       function abrirModal(idsucursal, clave, nombre) {
        ...
        function valida() {
           ...
           var clave = $("*[id$='clave']").val();
            ...
            if (clave == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la clave para el motivo de elección', 'warning', $("*[id$='clave']"));                
                return false;
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese el motivo de elección', 'warning', $("*[id$='nombre']"));
                return false;
