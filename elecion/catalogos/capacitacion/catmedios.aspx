<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="catmedios.aspx.cs" Inherits="elecion.catalogos.capacitacion.catmedios" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
            ...
            <div class="content-header row">
                ...
                <div class="col-md-3">
                    <div class="media-left media-middle">
                        <i class="fa fa-thumbs-o-up primary font-large-2 mr-1"></i>
                    </div>
                    <div class="media-body">
                        <h4 class="font-weight-bold">Medios de Interés</h4>
                                ...
                                AutoGenerateColumns="False" DataSourceID="DsListadoGastos" OnSorting="lgastos_Sorting" EnableSortingAndPagingCallbacks="true"
                                 GridLines="Horizontal" BorderWidth="0" RowStyle-CssClass="rowHover" ClientIDMode="Static" OnDataBinding="conteoRegistros">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="medio" HeaderText="Nombre" SortExpression="medio" ItemStyle-CssClass="font-small-3 font-weight-bold" HeaderStyle-CssClass="primary"/> 
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="editar" onclick="abrirModal(<%# Eval("idmedio")%>,'<%# Eval("clave").ToString() %>','<%# Eval("medio").ToString() %>')" class="btn btn-icon btn-warning mr-1 btn-sm"
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="select idmedio, clave, medio from medio ">
    ...
    <div class="modal fade text-xs-left" id="bootstrap"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
		        ...
		        <div class="modal-content">
			        ...
			        <h5 class="modal-title" id="myModalLabel35">MEDIO DE INTERÉS</h5>                                                                               
    ...
    <script>
       ...
       function abrirModal(idsucursal, clave, nombre) {
        ...
        function valida() {
            ...
            if (clave == '') {
                walert = 1;
                alerta('Atención', 'Ingrese la clave para el medio de intéres', 'warning', $("*[id$='clave']"));                
                return false;
            ...
            if (nombre == '') {
                walert = 1;
                alerta('Atención', 'Ingrese el medio de interés', 'warning', $("*[id$='nombre']"));
                return false;
