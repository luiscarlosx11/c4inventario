<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="diplomas.aspx.cs" Inherits="elecion.acreditacion.diplomas" EnableEventValidation="false" %>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Diplomas</a>
                </li>
              </ol>
            </div>
          </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cuerpo" runat="server">
 <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true"></asp:ScriptManager>
    ...
    <asp:Button runat="server" ID="BimprimirCredencial" OnClick="imprimeCredencial" Style="display: none" UseSubmitBehavior="false"/>
     <asp:Button runat="server" ID="bimprimirKardex" OnClick="imprimeKardex" UseSubmitBehavior="false" Style="display: none" />  
    <asp:Button runat="server" ID="BimprimirDiploma" OnClick="imprimeDiploma" Style="display: none" UseSubmitBehavior="false"/>  
            ...
            <div class="sidebar-left">
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel10">
                    <ContentTemplate>
                        ...
                        <asp:Button runat="server" ID="Bfinalizarcurso" OnClick="finalizaCurso" Style="display: none" UseSubmitBehavior="false"/>
                        <asp:Button runat="server" ID="Bguardacalif" OnClick="guardaCalificaciones" Style="display: none" UseSubmitBehavior="false"/>
                        ...
                        <div class="card">
                            <div class="card-head">
                                <div class="card-header">
                                    ...
                                    <h5 class="">Listado de Alumnos Acreditados</h5>
                                        ...
                                        <div style="overflow-x: auto; width: 100%">
                                            <asp:GridView runat="server" ID="GValumnos" PageSize="50" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="foliodiploma" HeaderText="Folio Diploma" ItemStyle-Width="50px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda"/>
                                                    <asp:BoundField DataField="fechadiploma" HeaderText="Fecha Diploma" ItemStyle-Width="50px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda"/>
                                                    ...
                                                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="250px" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda primary">
                                                        <ItemTemplate>
                                                            ...
                                                            <button type="button" onclick="imprimirDiploma(<%# Eval("idsolicitud")%>,<%# Eval("idalumno").ToString() %>,'<%# Eval("nocontrol").ToString() %>')"  class="btn btn-icon btn-info mr-1 btn-sm tooltips"
                                                                data-toggle="tooltip" data-original-title="Imprimir Diploma">
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="generales" aria-labelledby="tabgenerales" aria-expanded="true">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                                <ContentTemplate>
                                    ...
                                    <asp:Button runat="server" ID="bsolicitud" OnClick="recuperaSolicitud" Style="display: none" UseSubmitBehavior="false" />
    ...
    <div class="modal fade" id="wcancelar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel40" aria-hidden="true">
     ...
     <div class="modal fade" id="wcalificacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel40" aria-hidden="true">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary white">
                    ...
                    <h3 class="modal-title" id="nombrealumno">Asignar Folio</h3>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="folio" CssClass="form-control text-uppercase" placeholder="Folio" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                            <asp:GridView runat="server" ID="GVobjetivos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="folio" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda " HeaderText="Folio"/>
                                    <asp:BoundField DataField="fecha" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda " HeaderText="Fecha"/>
                                    <asp:TemplateField HeaderText="Estatus" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                        <ItemTemplate>
                                            ...
                                            <span class="tag bg-<%# Eval("estatus").Equals("CANCELADO")?"danger":"success"%>"><%# Eval("estatus")%></span>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" onclick="guardarCalificacion()" type="button" data-backdrop="false">
                        <i class="fa fa-check-square-o"></i>Aceptar
                    </button>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        function soloNumeros(event, element, _float){
	        event = event || window.event;
	        var charCode = event.which || event.keyCode;
	        //alert(charCode);

	        if (charCode == 8 || charCode == 13 || (charCode >36 && charCode <41)||(_float ? (element.value.indexOf('.') == -1 ? charCode == 46 : false) : false))
		        return true;
        ...
        function imprimirKardex(idsolicitud, idcurso, nocontrol) {
            ...
            $('#<%= bimprimirKardex.ClientID %>').click();
            cerrarLoading();
        }
        ...
        function imprimirDiploma(idsolicitud, idalumno, nocontrol) {
            ...
            $('#<%= BimprimirDiploma.ClientID %>').click();
            cerrarLoading();
        }
        ...
        function finalizarCurso() {          
                swal({
                title: "Se marcará este curso como finalizado, una vez hecho esto no podrán modificarse calificaciones ni alumnos ¿Desea continuar?",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: '#DD6B55',
                ...
                cancelButtonText: "No"
                    ...
                    if (result.value) {
                        mostrarLoading();
                         $('#<%= Bfinalizarcurso.ClientID %>').click();
         ...
         function guardarCalificacion() {
           ...
           var folio = $("*[id$='folio']").val();  
          

             if (folio == '' || folio == '0') {
                 alerta('Atención', 'Ingrese el folio del diploma', 'warning', $("*[id$='folio']"));
                return false;
             }
        ...
        function abrirModalObjetivo(idsolicitud, idcurso, nombre, folio) {
            ...
            $('#<%= Blistadoobjetivos.ClientID %>').click();
            //$("#wcalificacion").modal('show');
        }
