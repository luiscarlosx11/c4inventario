<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="frmacreditacion.aspx.cs" Inherits="elecion.acreditacion.frmacreditacion" EnableEventValidation="false" %>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary white">
                    ...
                    <h3 class="modal-title" id="nombrealumno">Calificaciones</h3>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="text-bold-600">Asistencias</label>
                                <asp:TextBox ID="asistencias" CssClass="form-control text-uppercase" placeholder="Asistencias" runat="server" onkeypress="return soloNumeros(event, this, false)" maxlength="3"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="text-bold-600">Días curso</label>
                                <asp:TextBox ID="totaldias" CssClass="form-control text-uppercase" placeholder="Dias" runat="server" disabled></asp:TextBox>
                            </div>
                        </div>
                        </div>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:GridView runat="server" ID="GVobjetivos" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="150px" HeaderText="Calificación" ItemStyle-Font-Size="Small" HeaderStyle-CssClass="primary">
                                        <ItemTemplate>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control calif" id="<%#Eval("idobjetivo")+"_"+Eval("calificacion")%>" value="<%#Eval("calificacion")%>" onkeypress="return soloNumeros(event, this, true)" maxlength="3"> </input>
                                            </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $("#frmacreditacion").addClass("active");
        var walert = 0;
        var fecha = '';
        ...
        function finalizarCurso() {          
         ...
         function guardarCalificacion() {
           ...
           var asistencias = $("*[id$='asistencias']").val();  
           var dias = $("*[id$='totaldias']").val();  
        
            $('.calif').each(function (id) {
                //if ($(this).closest("input").attr('checked')) {
                ids = ids + this.id +"_"+this.value+ "|";
             ...
             if (asistencias == '' || asistencias == '0') {
                 alerta('Atención', 'Ingrese el número de asistencias del alumno', 'warning', $("*[id$='asistencias']"));
                return false;
             }

              if (parseInt(asistencias) > parseInt(dias)) {
                 alerta('Atención', 'La cantidad de asistencias no puede exceder el total de días del curso', 'warning', $("*[id$='asistencias']"));
                return false;
             }
            ...
            if (error == 0) {                
                ...
                alerta('Atención', 'Existe(n) '+error+' objetivos(s) sin calificación asignada, indique la calificación de todos los objetivos del curso para continuar', 'warning', null); 
            }

        }

        function abrirModalObjetivo(idsolicitud, idcurso, nombre, dias, asistencias) {
           
            $("*[id$='idI']").val(idsolicitud);
            $("*[id$='idP']").val(idcurso);
            $("*[id$='nombrealumno']").html(nombre);
            $("*[id$='totaldias']").val(dias);
            $("*[id$='asistencias']").val(asistencias);
