<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="listadoventas.aspx.cs" Inherits="elecion.tickets.listadoventas" EnableEventValidation="false"%>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Ventas</a>
                </li>
              </ol>
            </div>
          </div>
                                            ...
                                            <div class="col-md-12"><br />
                                                <asp:GridView runat="server" ID="dlCustomers" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="categoria" HeaderText="Categoría" SortExpression="categoria" ItemStyle-Width="300px"/>                                                                                                             
                                                        <asp:BoundField DataField="fechaenajenacion" HeaderText="Enajenado en" SortExpression="fechaenajenacion" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda" ItemStyle-Width="120px"/>
                                                        <asp:BoundField DataField="precio" HeaderText="Precio" SortExpression="precio" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda" DataFormatString="{0:c}" HtmlEncode="False" ItemStyle-Width="120px"/>
                                                        <asp:BoundField DataField="descripcion" HeaderText="Artículo" SortExpression="descripcion" ItemStyle-Width="550px"/>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <br />
                                     <div class="row" id="dprecio">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="cliente" class="text-bold-600">Nuevo precio</label>
                                                <asp:TextBox ID="dinero" CssClass="form-control text-uppercase"  placeholder="Precio" name="precio" runat="server" ></asp:TextBox>
                                            </div>
                                        </div>
                                                                               
                                    </div>
                            
                                    <div class="row" id="dcliente">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="cliente" class="text-bold-600">Cliente</label>
                                                <asp:TextBox ID="comprador" CssClass="form-control text-uppercase"  placeholder="Cliente" name="cliente" runat="server" ></asp:TextBox>
                                            </div>
                                        </div>
                                                                               
                                    </div>

                                    <div class="row" id="dclientetel">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="cliente" class="text-bold-600">Teléfono</label>
                                                <asp:TextBox ID="telefono" CssClass="form-control text-uppercase"  placeholder="Teléfono" name="telefono" runat="server" ></asp:TextBox>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" id="dapartar">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="cliente" class="text-bold-600">Cantidad</label>
                                    ...
                                    <div class="row" id="dtventa">
                                     <div class="col-md-9">
                                            <div class="form-group">
                                                <label for="cliente" class="text-bold-600">Tipo de venta</label>
                                                <asp:DropDownList runat="server" ID="tipoventa" CssClass="select2 form-control" DataSourceID="Dstipoventa" DataTextField="tipoventa" DataValueField="idtipoventa"  style="width:90%">

                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="Dstipoventa" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT idtipoventa, tipoventa FROM tipoventa ORDER BY tipoventa" >                                                    
                                                </asp:SqlDataSource>
                                            </div>
                                        </div>
                                    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">     
    ...
    <script>
        ...
        function procesoRefrendo() {
            ...
            var precio = $("*[id$='hpago']").val();

            precio = parseFloat(precio);

            if (cliente == '') {
                swal("Atención", "Ingrese el nombre del cliente que realiza el apartado", "warning");
                return false;
            }

            if (telefono == '') {
                swal("Atención", "Ingrese un número de teléfono del cliente que realiza el apartado", "warning");
                return false;
            }
            ...
            if (cantidad > precio) {
                swal("Atención", "La cantidad del apartado no puede ser mayor al precio del artículo", "warning");
                return false;
            }

            
             swal({
                title: "Se realizará el apartado de este artículo, ¿Desea continuar?",
                text: "",
                type: "warning",
        ...
        function procesoEnajenar() {
            ...
            var precio = $("*[id$='dinero']").val();

            var precioorig = $("*[id$='hpago']").val();

            precioorig = parseFloat(precioorig);
                     
            if (precio == '' || precio == '0') {
                swal("Atención", "Ingrese el nuevo precio de venta para este artículo", "warning");
                return false;
            }
            ...
            if (precio < precioorig) {
                swal("Atención", "Ingrese un precio de venta igual o mayor al precio original del artículo", "warning");
                return false;
            }

             swal({
                title: "Se modificará el precio de este artículo, ¿Desea continuar?",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
        ...
        function ModalRefrendo(idempeno, idsucursal, idarticulo, folio, cliente, articulo, prestamo,op) {
        ...
        function abrirModalRefrendo(op) {
            ...
            if (op == 3) {
                ...
                if (op == 5) {
                    ...
                    $("*[id$='titulo']").text('MODIFICAR PRECIO');
                    $("#bmrefrendar").hide();
                    $("#bmdesempeno").hide();
                    $("#bmenajenar").show();
                    $("#dprecio").show();
