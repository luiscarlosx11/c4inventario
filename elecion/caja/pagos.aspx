<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false"
     CodeBehind="pagos.aspx.cs"  Inherits="elecion.ingresos.pagos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cuerpo" runat="server">
 <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true"></asp:ScriptManager>
        ...
        <ContentTemplate>
            <div class="content-header row">
                ...
                <div class="col-md-9 float-md-right">
                    ...
                    <asp:HiddenField runat="server" ID="idA" Value="190" />
                    ...
                    <asp:HiddenField runat="server" ID="bandpago" Value="0" />
                       ...
                       <div class="media">
                           ...
                           <div class="col-md-3">
                               <div class="form-group">      
                                   ...
                                   <asp:TextBox ID="bnamecurso" CssClass="form-control text-uppercase" placeholder="Búsqueda por Nombre, Clave..." name="bname" runat="server" AutoPostBack="false" onChange="consultaPrincipal()"></asp:TextBox>
                               </div>
                           </div>
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-md-2" runat="server">
                                       <div class="form-group">
                                           ...
                                           <asp:SqlDataSource ID="DSperiodo" runat="server" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT 999999 as idperiodo, 'SELECCIONE UN PERIODO'as periodo ">
                                        ...
                                        <asp:GridView runat="server" ID="lGeneral" PageSize="50" AllowPaging="true" AllowSorting="true" CssClass="table table-striped lGeneral"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Curso" HeaderStyle-CssClass="primary">
                                                 ...
                                                 <asp:TemplateField HeaderText="Alumno" ItemStyle-Width="400px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>     
                                                    <h7 class="font-weight-bold"><%# Eval("alumno")%></h7><br />
                                                   <span>
                                                        <span class="tag bg-<%# Eval("becadocheck").Equals("checked")?"success":"danger"%>"><span class="text-bold-700"><%#"BECADO POR " +Eval("porcentaje") + " %"%></span></span>
                                                        </span>  
                                                ...
                                                <asp:TemplateField HeaderText="Saldos" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>                                                                                                       
                                                        <span class="tag bg-<%# Eval("pagadotext").Equals("PAGADO")?"success":"danger"%>"><span class="text-bold-700"><%# Eval("pagadotext")%></span></span>                                                          
                                                    <br />
                                                     <ul class="list-inline clearfix">
                                                          <li class="border-right-blue-grey border-right-lighten-2 pr-2">
                                                            <h7 class="black font-weight-bold font-medium-3"><%# "$ "+Eval("saldoapagar")%></h7><br />
                                                            <span class="font-small-3" >Costo</span>
                                                        </li>

                                                        <li class="border-right-blue-grey border-right-lighten-2 pr-2 pl-2">
                                                            <h7 class="primary font-weight-bold font-medium-3"><%# "$ "+Eval("saldopagado")%></h7><br />
                                                            <span class="font-small-3" >Pagado</span>
                                                        </li>
                                                        <li class="pl-2">
                                                            <h7 class="danger font-weight-bold font-medium-3"><%# "$ "+Eval("saldorestante")%></h7><br />
                                                            <span class="font-small-3" >Por Pagar</span>
                                                        </li>
                                                    </ul>
                                            ...
                                            <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="220px" HeaderStyle-CssClass="centrarCelda primary" ItemStyle-CssClass="centrarCelda">
                                                <ItemTemplate>
                                                    <button type="button" class="btn btn-icon btn-success mr-1 btn-sm tooltips"  onclick="abrirModalPago(<%# Eval("idsolicitud") %>, <%# Eval("idcurso") %>, <%# Eval("idsucursal") %>,<%# Eval ("saldoapagar") %>,<%# Eval ("saldopagado") %>,<%# Eval ("saldorestante") %>, '<%# Eval("clave")+ " / "+Eval("nombre") %>','<%# Eval("alumno") %>')" value="" data-toggle="tooltip" data-original-title="Pagar" <%# Eval("pagadotext").Equals("PAGADO")?"disabled":"" %>><i class="fa fa-money"> </i> </button>                                                                                                                                                                                                                                               
                                                    <button type="button" class="btn btn-icon btn-info mr-1 btn-sm tooltips"  onclick="imprimirOficial(<%# Eval("idsolicitud") %>,<%# Eval("recoficial") %>, '<%# Eval("nocontrol") %>')" value="" data-toggle="tooltip" data-original-title="Recibo Oficial" <%# Eval("pagadotext").Equals("PAGADO")?"":"disabled" %>><i class="ft-printer"> </i> </button>
                                                    <button type="button" class="btn btn-icon btn-warning mr-1 btn-sm tooltips"  onclick="abrirModalHistorial(<%# Eval("idsolicitud") %>,<%# Eval("idsucursal") %>,'<%# Eval("nocontrol") %>')" value="" data-toggle="tooltip" data-original-title="Historial de Pagos"><i class="fa fa-history"> </i> </button>                                                                                                                                                                                                                           
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            </Columns>
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content px-1 pt-1">
                        ...
                        <div class="tab-pane fade" id="horario" role="tabpanel" aria-labelledby="tabhorario" aria-expanded="false">
                            ...
                            <asp:Button runat="server" ID="bimprimiroficial" OnClick="imprimirOficial" UseSubmitBehavior="false" Style="display: none" />
                            <asp:Button runat="server" ID="bimprimirprovisional" OnClick="imprimirProvisional" UseSubmitBehavior="false" Style="display: none" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <asp:Button runat="server" ID="Bguardarpago" OnClick="guardaPago" Style="display: none" CausesValidation="false" UseSubmitBehavior="false" />
   ...
   <div class="modal fade" id="wfechas"  role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
    ...
    <div class="modal fade" id="wpago"  role="dialog" aria-labelledby="myModalLabel40" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="cursopago" CssClass="form-control text-uppercase" placeholder="Concepto" name="nombre" runat="server" disabled></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-bold-600">Alumno</label>
                                <asp:TextBox ID="alumnopago" CssClass="form-control text-uppercase" placeholder="Concepto" name="nombre" runat="server" disabled></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="text-bold-600">Concepto</label>
                                <asp:TextBox ID="conceptopago" CssClass="form-control text-uppercase" placeholder="Concepto" name="nombre" runat="server"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="costopago" CssClass="form-control decimal-inputmask text-md-left text-uppercase" Style="text-align: left;" placeholder="Costo Modulo" name="cotitular" runat="server" disabled></asp:TextBox>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="text-bold-600">Pagado</label>
                                <asp:TextBox ID="pagadopago" CssClass="form-control decimal-inputmask text-md-left text-uppercase" Style="text-align: left;" placeholder="Pagado" name="cotitular" runat="server" disabled></asp:TextBox>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="text-bold-600">Por pagar</label>
                                <asp:TextBox ID="porpagarpago" CssClass="form-control decimal-inputmask text-md-left text-uppercase" Style="text-align: left;" placeholder="Por pagar" name="cotitular" runat="server" disabled></asp:TextBox>
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="text-bold-600">Importe</label>
                                <asp:TextBox ID="importepago" CssClass="form-control decimal-inputmask text-md-left text-uppercase" Style="text-align: left;" placeholder="Importe a pagar" name="cotitular" runat="server"></asp:TextBox>
     ...
     <div class="modal fade" id="whistorial"  role="dialog" aria-labelledby="myModalLabel40" aria-hidden="true">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary white">
                    ...
                    <h3 class="modal-title">Historial de Pago</h3>
                </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <asp:Button runat="server" ID="Bhistorial" OnClick="modallistadoHistorialg" style="display:none" UseSubmitBehavior="false"/>
                                            <asp:Button runat="server" ID="Bcancelarpago" OnClick="cancelarPago" Style="display: none" UseSubmitBehavior="false"/>

                                            <asp:GridView runat="server" ID="GVhistorialg" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration" 
                                                AutoGenerateColumns="False" DataSourceID="DShistorialg" EnableSortingAndPagingCallbacks="true"
                                                AlternatingRowStyle-BackColor="#F5F7FA" OnPageIndexChanged="listadoHistorialg" OnRowDataBound="coloresFilas">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="folio" HeaderText="Folio" SortExpression="folio" ItemStyle-Font-Size="Small" ItemStyle-CssClass="centrarCelda " HeaderStyle-CssClass="centrarCelda" />                                                    
                                                    <asp:BoundField DataField="fecha" HeaderText="Fecha" SortExpression="fecha"  ItemStyle-Width="150px" ItemStyle-Font-Size="Small" ItemStyle-CssClass="centrarCelda " HeaderStyle-CssClass="centrarCelda"/>
                                                    
                                                    <asp:BoundField DataField="concepto" HeaderText="Concepto" SortExpression="concepto" ItemStyle-Font-Size="Small" />
                                                    <asp:BoundField DataField="importe" HeaderText="Importe" SortExpression="importe" ItemStyle-Font-Size="Small" ItemStyle-CssClass="centrarCelda " HeaderStyle-CssClass="centrarCelda" DataFormatString="{0:c}" HtmlEncode="False"/>
                                                    ...
                                                    <ItemTemplate>                                                         
                                                            <span class="tag bg-<%# Eval("estatus").Equals("PAGADO")?"success":Eval("estatus").Equals("CANCELADO")?"danger":""%>"><%# Eval("estatus")%></span>                                                                                                                                                      
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <button type="button" class="btn btn-icon btn-info mr-1 btn-sm tooltips"  onclick="imprimirProvisional(<%# Eval("idsolicitud") %>,<%# Eval("idpago") %>)" value="" data-toggle="tooltip" data-original-title="Imprimir Recibo"><i class="ft-printer"> </i> </button>
                                                        <button type="button" class="btn btn-icon btn-danger mr-1 btn-sm tooltips"  onclick="abrirModalCancelar(<%# Eval("idsolicitud") %>,<%# Eval("idpago") %>)" value="" data-toggle="tooltip" data-original-title="Cancelar"><i class="ft-delete"> </i> </button>
                                            ...
                                            <asp:SqlDataSource ID="DShistorialg" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>"></asp:SqlDataSource>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary white">
                    ...
                    <h3 class="modal-title">Cancelar Pago</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="cancelacionmot" CssClass="form-control text-uppercase" MaxLength="0" TextMode="MultiLine" Rows="3" placeholder="Motivo" runat="server"></asp:TextBox>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" onclick="cancelarPago()" type="button" data-backdrop="false">
                        <i class="fa fa-check-square-o"></i>Aceptar
                    </button>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        function abrirModalHistorial(idsolicitud, idsucursal, nocontrol) {
            mostrarLoading();

            $("*[id$='idP']").val(idsolicitud);
            $("*[id$='idS']").val(idsucursal);
            $("*[id$='cve']").val(nocontrol);
            // $("#whistorial").modal('show');     
            $('#<%= Bhistorial.ClientID %>').click();
            
        }

        function abrirModalPago(idsolicitud, idcurso, idsucursal, saldoapagar, saldopagado, saldorestante, curso, alumno) {                        
           //mostrarLoading();
            $("*[id$='idP']").val(idsolicitud);
            $("*[id$='idC']").val(idcurso);
            $("*[id$='idS']").val(idsucursal);

            $("*[id$='cursopago']").val(curso);
            $("*[id$='alumnopago']").val(alumno);

            $("*[id$='conceptopago']").val('');
            $("*[id$='costopago']").val(saldoapagar);
            $("*[id$='pagadopago']").val(saldopagado);
            $("*[id$='porpagarpago']").val(saldorestante);
            $("*[id$='importepago']").val('0');
            $("*[id$='motcancelacion']").val('');
        ...
        function validaPago() {
            ...
            var costopago = $("*[id$='costopago']").val();
            var pagadopago = $("*[id$='pagadopago']").val();
            var conceptopago = $("*[id$='conceptopago']").val();
            var porpagar = $("*[id$='porpagarpago']").val();              
            var importepago = $("*[id$='importepago']").val();                                   
            walert = 1;

             if (conceptopago == '') {
                alerta('Atención', 'Ingrese el concepto del pago a realizar', 'warning', $("*[id$='conceptopago']"));
                return false;
            }

            if (porpagar>0&&(importepago == '' || parseFloat(importepago) == 0)) {
                alerta('Atención', 'Ingrese el importe del pago a realizar', 'warning', $("*[id$='importepago']"));
                return false;
            }
                                  
            if (parseFloat(importepago) > parseFloat(porpagar) ) {
                alerta('Atención', 'El importe a pagar debe ser igual o menor que el saldo restante', 'warning', $("*[id$='importepago']"));
                return false;
            }

            var total = parseFloat(importepago) + parseFloat(pagadopago);

            if (parseFloat(total) == parseFloat(costopago)) {

                
                //UN SOLO PAGO
                if (parseFloat(pagadopago) == 0)
                    $("*[id$='bandpago']").val(1);
                else
                    $("*[id$='bandpago']").val(2);
                ...
                var resp = Swal({
                    title: 'Ingrese el folio del recibo oficial',
                    input: 'text',
                    ...
                    inputValidator: (value) => {
                        if (!value) {
                            return 'Ingrese un folio válido'
                        } else {
        ...
        function imprimirOficial(idsolicitud, idpago, nocontrol) {
            $("*[id$='idP']").val(idsolicitud);
            $("*[id$='idC']").val(idpago);
            $("*[id$='cve']").val(nocontrol);
            mostrarLoading();
            $('#<%= bimprimiroficial.ClientID %>').click();
            cerrarLoading();
        }

        function imprimirProvisional(idsolicitud, idpago) {
            $("*[id$='idP']").val(idsolicitud);
            $("*[id$='idC']").val(idpago);
            
            mostrarLoading();
            $('#<%= bimprimirprovisional.ClientID %>').click();
            cerrarLoading();
        }

        function abrirModalCancelar(idsolicitud, idpago) {                                 
            $("*[id$='idP']").val(idsolicitud);
            $("*[id$='idC']").val(idpago);
            $("*[id$='cancelacionmot']").val('');
            $("#wcancelar").modal('show');                                                                                                         
        }

        function cancelarPago() {
            swal({
                title: "Se realizará la cancelación de este pago, ¿Desea continuar?",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: '#DD6B55',
