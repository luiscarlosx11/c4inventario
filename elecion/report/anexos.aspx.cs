...
*/
        ...
        {
            ReportLibrary.FormatoGruposVulnerables reporte = new ReportLibrary.FormatoGruposVulnerables();
            reporte.ReportParameters["idsucursal"].Value = bplantelg.SelectedValue;
            reporte.ReportParameters["idcicloescolar"].Value = bciclog.SelectedValue;
            reporte.ReportParameters["idperiodo"].Value = bperiodog.SelectedValue;
            ExportToPDF(reporte, "RTF");
        }

        protected void imprimeCursos(object sender, EventArgs e)
        {
            ReportLibrary.FormatoCursos reporte = new ReportLibrary.FormatoCursos();
            reporte.ReportParameters["idsucursal"].Value = bplantel.SelectedValue;
            reporte.ReportParameters["idcicloescolar"].Value = bciclo.SelectedValue;
            reporte.ReportParameters["idperiodo"].Value = bperiodo.SelectedValue;
            ExportToPDF(reporte, "XLS");
        }

        protected void imprimeDiplomas(object sender, EventArgs e)
        {
            ReportLibrary.DiplomasExpedidos reporte = new ReportLibrary.DiplomasExpedidos();
            reporte.ReportParameters["idsucursal"].Value = bplantelDip.SelectedValue;
            reporte.ReportParameters["idperiodo"].Value = bperiodoDip.SelectedValue;
            ExportToPDF(reporte, "PDF");
        }
