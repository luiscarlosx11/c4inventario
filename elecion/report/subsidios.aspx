<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="subsidios.aspx.cs" Inherits="elecion.report.subsidios" %>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Subsidios</a>
                </li>
              </ol>
            </div>
          </div>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">PROPIOS</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 border-right-blue-grey border-right-lighten-5 border-left-blue-grey border-left-lighten-5">
                                        <div class="card-block text-xs-center">
                                            <div class="card-header mb-2">
                                                <span class="success">Excel</span>
                                                <h1 class=" blue-grey darken-1">Reporte Quincenal</h1>
                                            </div>
                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12" runat="server">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label for="atiende" class="text-bold-600">Tipo de Curso</label>
                                                                            <asp:DropDownList runat="server" ID="btipocurso" CssClass="select2 form-control" DataSourceID="DStipocurso" DataTextField="tipocurso" DataValueField="idtipocurso" Style="width: 100%">
                                                                            </asp:DropDownList>
                                                                            <asp:SqlDataSource ID="DStipocurso" ProviderName="MySql.Data.MySqlClient" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>"
                                                                                SelectCommand="SELECT idtipocurso, tipocurso from tipocurso order by tipocurso desc"></asp:SqlDataSource>
                                                                        </div>
                                                                    </div>
                                                                </div>
