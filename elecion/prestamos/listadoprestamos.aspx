...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12">
        <div class="row">
                ...
                <asp:Button runat="server" ID="Bcancelar" OnClick="cancelaEmpeno" Style="display: none" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="0px" ItemStyle-CssClass="ocultar" HeaderStyle-CssClass="ocultar">
                                                            <ItemTemplate>
                                                                <div class="ocultar">
                                                                    ...
                                                                    <button type="button" id="refrendar_<%#Eval("idempeno")+"_"+Eval("idsucursal")%>" onclick="ModalRefrendo(<%#Eval("idempeno")%>,<%# Eval("idsucursal")%>,<%# Eval("idarticulo")%>,'<%# Eval("folio")%>','<%# Eval("cliente")%>','<%# Eval("descripcion").ToString().Replace("\"","PULG")%>',<%# Eval("prestamo")%>,'<%# Eval("pagar")%>',<%# Eval("tasa")%>,<%# Eval("dias")%>,<%# Eval("recargos")%>,1);" class="btn btn-icon btn-success btn-sm"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                                                    ...
                                                    <asp:GridView runat="server" ID="ghistorial" PageSize="10" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <ItemTemplate>
                                                                    ...
                                                                    <div class="<%# Eval("idtipomovimiento").Equals(2)||Convert.ToInt32(Eval("idtipomovimiento"))>=99?"ocultar":"" %>">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger mr-1" onclick="validaCancelacion()">
                                <i class="ft-x"></i> Cancelar Empeño	                    
                            </button>
                            <button type="button" class="btn btn-success mr-1" data-dismiss="modal" id="cerrarM2">
                                <i class="icon-logout"></i> Cerrar	                    
                            </button>
    ...
    <script>
       ...
       /* $(document).ready(function () {
        ...
        function validaCancelacion() {
             ...
             swal({
                title: "Se realizará la cancelación sobre esta boleta, ¿Desea continuar?",
                text: "",
                type: "warning",
            ...
            function (isConfirm) {
                if (isConfirm) {
                    mostrarLoading();
                    $("#mhistorial").modal('hide');
                    $('#<%= Bcancelar.ClientID %>').click(); 
