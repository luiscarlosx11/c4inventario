<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RVVentas.aspx.cs" Inherits="elecion.reportes.RVVentas" EnableEventValidation="false"  %>
...
<head runat="server">
    <title>Rendilana - Reporte Ventas</title>
...
<body>
    <form runat="server">
        ...
        <telerik:ReportViewer
            ...
            <ReportSource IdentifierType="TypeReportSource" Identifier="ReportLibrary.ReportVentas, ReportLibrary">
                <Parameters>                    
