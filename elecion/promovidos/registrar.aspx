<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="registrar.aspx.cs" Inherits="elecion.promovidos.registrar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
       .item tr {cursor:pointer;}
       .item tr:hover{background-color:#E6F0FA;}
    </style>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Registro de Promovidos</h4>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <asp:GridView runat="server" Width="100%" ID="gBusqueda" AutoGenerateColumns="false" DataSourceID="DsBusqueda" OnRowCreated="gBusqueda_RowCreated"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Promovido" ItemStyle-Width="15px"  ItemStyle-HorizontalAlign="Center">
                                                         <ItemTemplate>  
                                                             <div class="row skin skin-flat">
                                                             <div class="state icheckbox_flat-green <%# Eval("promovido")%> mr-1"></div>
                                                             </div>
                                                         </ItemTemplate>
                                                    </asp:TemplateField> 
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        function valida() {
            ...
            var apaterno = $("*[id$='nombre']").val();
            var amaterno = $("*[id$='nombre']").val();
