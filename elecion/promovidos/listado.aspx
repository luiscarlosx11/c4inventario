<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false"  
    CodeBehind="listado.aspx.cs" Inherits="elecion.promovidos.listado" %>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">LISTADO DE PROMOVIDOS</h4>
                        ...
                        <div class="card-body collapse in">
                            ...
                            <div class="card-block card-dashboard">
                                <p class="card-text">
                                    ...
                                    <asp:HiddenField runat="server" ID="clave_e" />
                            ...
                            <div class="card-block card-dashboard">
                                <div style="overflow-x: auto; width: 100%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Acciones">
                                                <ItemTemplate>
                                                    ...
                                                    <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idP")%>,'<%# Eval("clave_e")%>')" class="btn btn-icon btn-danger mr-1" data-toggle="tooltip" data-original-title="Borrar">
                                                        <i class="ft-delete"></i>
                                                    </button>
                                    ...
                                    <asp:SqlDataSource ID="DsListado" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" 
                                        SelectCommand="SELECT [idP], [clave_e], ([nombre]+' '+[paterno]+' '+ [materno])as completo, [seccion], [email], [telefono] FROM [promovidos] WHERE entidad = @ent and seccion=@seccion">
                                        <SelectParameters>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">    
    ...
    <script>
        ...
        function eliminarRegistro(idP,clave_e) {
            $("*[id$='idP']").val(idP);
            $("*[id$='clave_e']").val(clave_e);
