<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="listadoconsulta.aspx.cs" Inherits="elecion.tickets.listadoconsulta" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="titulobreads" runat="server">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h3 class="content-header-title">Histórico</h3>
          </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <button type="button" id="bauxrefrendar" onclick="abrirModalRefrendo(1);" class="btn btn-icon btn-warning">
                                                    <i class="fa fa-undo"></i>  Historial
                                                </button>
                                            ...
                                            <div class="col-md-12"><br />
                                                <asp:GridView runat="server" ID="dlCustomers" PageSize="25" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="cliente" HeaderText="Cliente" SortExpression="cliente" ItemStyle-Width="380px" />
                                                        <asp:BoundField DataField="fechaempeno" HeaderText="Fecha" SortExpression="fechaempeno" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda" ItemStyle-Width="180px" />
                                                        <asp:BoundField DataField="etapa" HeaderText="Estatus" SortExpression="etapa" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda" />
                                                        <asp:BoundField DataField="prestamo" HeaderText="Préstamo" SortExpression="prestamo" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda" DataFormatString="{0:c}" HtmlEncode="False"  />
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">     
    ...
    <script>
        ...
        $("#listahistorico").addClass("active");
