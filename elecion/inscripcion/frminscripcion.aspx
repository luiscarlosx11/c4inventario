...
<asp:Content ID="Content3" ContentPlaceHolderID="titulobreads" runat="server">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h3 class="content-header-title">INSCRIPCIÓN</h3>
          </div>
                                    ...
                                    <div class="list-group list-group-messages vertical-scroll scroll-example height-800">
                                        <asp:DataList ID="lgrupos" runat="server" DataSourceID="DSgrupos" RepeatLayout="Flow" RepeatDirection="Horizontal">
                                            <ItemTemplate>
                                                ...
                                                <a href="#" class="list-group-item list-group-item-action border-0" onclick="buscacursos(<%# Eval("idcurso")%>, this.id, '<%# Eval("nombre")%>')" id="grupo_<%# Eval("idcurso")%>">
                            ...
                            <div class="card-head">
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        <button type="button" id="nuevo" onclick="abrirModal(0, 0);" class="btn btn-icon btn-primary mr-1" data-toggle="modal" runat="server">
                                           Nueva inscripción
                                        </button>
                                    </div>
                                </div>
                                                    ...
                                                    <asp:TemplateField HeaderText="Estatus" ItemStyle-Width="20px" HeaderStyle-CssClass="centrarCelda" ItemStyle-CssClass="centrarCelda">
                                                        <ItemTemplate>
                                                            ...
                                                            <span class="float-xs-right">
                                                                <span class="tag bg-<%# Eval("estatus").Equals("INSCRITO")?"success":Eval("estatus").Equals("CANCELADO")?"danger":Eval("estatus").Equals("DESERCIÓN")?"danger":""%>"> <%# Eval("estatus")%></span>
                                                            </span>                                                                                                
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="320px" ItemStyle-CssClass="centrarCelda" HeaderStyle-CssClass="centrarCelda">
                                                        <ItemTemplate>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        function buscacursos(idgrupo, obj, nombre) {
