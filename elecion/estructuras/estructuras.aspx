<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false"  
    CodeBehind="estructuras.aspx.cs" Inherits="elecion.estructuras.estructuras" %>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">CLASIFICACIÓN DE ESTRUCTURAS</h4>
                        ...
                        <div class="card-body collapse in">
                                    ...
                                    <div class="card-block card-dashboard">
                                        <p class="card-text">  </p>                
                                         ...
                                         <div class="col-md-9">
                                            ...
                                            <button type="button" id="nuevo" onclick="nuevoRegistro();" class="btn btn-icon btn-success mr-1" >
                                ...
                                <asp:GridView runat="server" ID="lestructuras" PageSize="25" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered base-style" 
                                AutoGenerateColumns="False"  DataSourceID="DsListado" DataKeyNames="idEstructura" OnSorting="lpromovidos_Sorting" EnableSortingAndPagingCallbacks="true" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending" BackColor="#16D39A" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nombre" HeaderText="Estructura" SortExpression="nombre" />
                                            <asp:BoundField DataField="descripcion" HeaderText="Descripción" SortExpression="descripcion" />
                                            
                                            <asp:TemplateField HeaderText="Acciones">
                                                <ItemTemplate>                                                                                                      

                                                    <button type="button" id="editar" onclick="editarRegistro(<%# Eval("idEstructura")%>)" class="btn btn-icon btn-success mr-1" data-toggle="tooltip" data-original-title="Editar">
                                                         <i class="ft-edit"></i>
                                                    </button>

                                                     <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idEstructura")%>)" class="btn btn-icon btn-danger mr-1" data-toggle="tooltip" data-original-title="Borrar">
                                                         <i class="ft-delete"></i>
                                                    </button>
                                    ...
                                    <asp:SqlDataSource ID="DsListado" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT [idEstructura], [nombre], [descripcion] FROM [estructuras] order by [nombre] ">                                        
                                    </asp:SqlDataSource>
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $(document).prop('title', 'PLACEL - Registro de Estructuras');
