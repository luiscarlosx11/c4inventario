<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false"  
    CodeBehind="listadogastos.aspx.cs" Inherits="elecion.presupuesto.gastos.listadogastos" %>
          ...
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Gastos</a>
                </li>
              </ol>
            </div>
          </div>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body collapse in">
                                ...
                                AutoGenerateColumns="False" DataKeyNames="idgasto" DataSourceID="DsListadoGastos" OnSorting="lgastos_Sorting" EnableSortingAndPagingCallbacks="true" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending" BackColor="#16D39A" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="fecha" ItemStyle-Width="70px" HeaderText="Fecha" SortExpression="fecha" DataFormatString="{0:yyyy/MM/dd}" HtmlEncode="false" HeaderStyle-HorizontalAlign="Center"/>  
                                            <asp:BoundField DataField="seccion" HeaderText="Seccion" SortExpression="seccion" HeaderStyle-HorizontalAlign="Center"/>  
                                            <asp:BoundField DataField="concepto" HeaderText="Concepto" SortExpression="concepto"/>  
                                            <asp:TemplateField HeaderText="Acciones">
                                                <ItemTemplate>                                                                                                      

                                                    <button type="button" id="editar" onclick="editarRegistro(<%# Eval("idgasto")%>)" class="btn btn-icon btn-success mr-1" data-toggle="tooltip" data-original-title="Editar">
                                                         <i class="ft-edit"></i>
                                                    </button>

                                                     <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idgasto")%>)" class="btn btn-icon btn-danger mr-1" data-toggle="tooltip" data-original-title="Borrar">
                                                         <i class="ft-delete"></i>
                                                    </button>
                                    ...
                                    <asp:SqlDataSource ID="DsListadoGastos" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT idgasto, fecha, concepto, seccion FROM gasto ORDER BY fecha ">
...
<asp:Content ID="Content4" ContentPlaceHolderID="JavaScript" runat="server">
    ...
    <script>
        ...
        $(document).prop('title', 'PLACEL - Listado de Gastos');
