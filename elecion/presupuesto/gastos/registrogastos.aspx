<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeBehind="registrogastos.aspx.cs" Inherits="elecion.presupuesto.gastos.registrogastos" %>
	        ...
	        <div class="col-md-12">
	            <div class="card">
	                <div class="card-header">
	                    <h4 class="card-title" id="horz-layout-basic">Registro de Gastos</h4>
	                ...
	                <div class="card-body collapse in">
						    ...
						    <div class="card-text">
							    <p>
	                    		   ...
	                    		   <div class="form-group row">
	                            	    <label class="col-md-3 label-control" for="fecha">Fecha</label>
		                                <div class="col-md-3">     
                                            
                                            <asp:TextBox ID="fecha" CssClass="form-control pickadate" maxlength="50" placeholder="Fecha" name="fecha" runat="server" ></asp:TextBox>
                                        </div>
		                           </div>
                                   ...
                                   <div class="form-group row">
	                            	    <label class="col-md-3 label-control" for="seccion">Otorgado a Sección</label>
		                                <div class="col-md-2">
                                            <asp:DropDownList runat="server" ID="seccion" CssClass="select2 form-control" DataSourceID="DsSecciones" DataTextField="seccion" DataValueField="seccion" AutoPostBack="false"></asp:DropDownList>
                                            <asp:SqlDataSource ID="DsSecciones" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT [seccion] FROM [secciones] where entidad = 18 ORDER BY [seccion]"></asp:SqlDataSource>
                        ...
                        <div class="card-block card-dashboard"> 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending" BackColor="#16D39A" ForeColor="White"/>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Acciones">
                                                <ItemTemplate>                                                                                                      
                                                     ...
                                                     <button type="button" id="borrar" onclick="eliminarRegistro(<%# Eval("idtipogasto")%>)" class="btn btn-icon btn-danger mr-1" data-toggle="tooltip" data-original-title="Borrar">
                                                         <i class="ft-delete"></i>
                                                    </button>
                                    ...
                                    <asp:SqlDataSource ID="DsListado" runat="server" ConnectionString="<%$ ConnectionStrings:DBconexion %>" SelectCommand="SELECT d.idgasto, d.idtipogasto, t.tipogasto, d.monto FROM detalleGasto d LEFT JOIN tipoGasto t on t.idtipogasto = d.idtipogasto where idgasto=@idgasto order by t.tipogasto ">                                        
                                    <SelectParameters>
