                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" id="datiende" runat="server">
                                                    <div class="form-group">
                                                        <label for="atiende" class="text-bold-600">Unidad Educativa</label>
                                                        <asp:DropDownList runat="server" ID="bcategoria" CssClass="select2 form-control" DataSourceID="Dsusuarios" DataTextField="nombre" OnSelectedIndexChanged="listadoGrid" AutoPostBack="true" DataValueField="idsucursal" Style="width: 100%" AppendDataBoundItems="true" >
                                                ...
                                                <div class="col-md-4" id="Div1" runat="server">
                                                    <div class="form-group">                                                        
                                                        <label class="text-bold-600">Aula</label>
                                                                        ...
                                                                        <asp:TextBox ID="bmunicipio" CssClass="form-control text-uppercase" required="required" data-validation-required-message="Campo requerido" MaxLength="60" placeholder="Nombre del Aula..." name="nombre" runat="server" AutoPostBack="true" OnTextChanged="listadoGrid"></asp:TextBox>
                            ...
                            <asp:GridView runat="server" ID="lgastos" PageSize="50" AllowPaging="true" AllowSorting="true" CssClass="table table-striped table-bordered zero-configuration" 
                                ...
                                <SortedDescendingHeaderStyle CssClass="descending rendila-color" ForeColor="White"/>
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="sucursal" HeaderText="Unidad Educativa" ItemStyle-Width="300px" SortExpression="sucursal" /> 
